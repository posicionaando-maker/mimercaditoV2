...
// ==================== NAVEGACIÓN POR TABS (SOLUCIÓN PRINCIPAL) ====================
function cambiarTab(tabId) {
    ...
    document.querySelectorAll('.tab').forEach(btn => {
        ...
        if ((tabId === 'pos' && btnTab === 'pos') ||
            (tabId === 'inventario' && btnTab === 'inventario') ||
            (tabId === 'datos' && btnTab === 'datos')) {
...
document.querySelectorAll('.tab').forEach(btn => {
    btn.addEventListener('click', () => {
        ...
        else if (tab === 'inventario') cambiarTab('inventario');
        else if (tab === 'datos') cambiarTab('datos');
    });
});
...
(async function init() {
    ...
    // Asegurar que POS sea la pantalla visible al inicio
    cambiarTab('pos');
})();